...
import 'package:workiom/features/auth/ui/complete_info/hooks/register_first_name_hook.dart';
import 'package:workiom/features/auth/ui/complete_info/providers/complete_info_controller_provider.dart';

class RegisterFirstNameWidget extends HookConsumerWidget {
  const RegisterFirstNameWidget({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final controller = useRegisterFirstNameController(
      ref: ref,
      initialText: '',
    );
    ...
    return Column(
      ...
      children: [
        Text(
          AppStrings.strYourFirstName.tr(context),
        ...
        AppTextFieldWidget(
          ...
          hintText: AppStrings.strEnterYourFirstName.tr(context),
